...
* **7. Load, add, save**
  * [7-add_item.py.py](./7-add_item.py): Python script that stores all command line arguments to a
  Python list saved in the file `add_item.json`.

* **8. Class to JSON.py**
  * [8-class_to_json.py.py](./8-class_to_json.py): Python function that returns the dictionary
